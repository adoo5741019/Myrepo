...
path_to_jpg_file = "PeppersRGB.bmp"
...
class AgglomerativeClustering:
    ...
    def fit(self, points):
        ...
        self.distance_matrix = squareform(pdist(np.array([np.average(cluster, axis=0) for cluster in self.clusters_list])))
    ...
    def plot_dendrogram(self):
        linkage_matrix = linkage(self.distance_matrix, method='complete')
